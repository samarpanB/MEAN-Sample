...
define('text!formBuilder/formField.html',[],function () { return '<input ng-class="{{formItemDetail.css}}" type="text" name="{{formItemDetail.name}}" ng-attr-placeholder="{{formItemDetail.placeholder}}">';});

define('formBuilder/formFieldDirective',['jquery', 'formBuilder/formFieldController', 'text!formBuilder/formField.html'], 
