  ...
  'use strict';
    ...
    return ['$scope', '$element', 'formUtils', 'formDefaultValidationMessages',
        ...
        function (scope, $element, formUtils, formDefaultValidationMessages,
            ...
            this.fbTmplInstance = formFieldTemplateService.init();
...
define('formBuilder/formFields/formFieldController',['angular'], function () {
  'use strict';
...
define('formBuilder/formFields/formFieldDirective',['jquery', 'formBuilder/formFields/formFieldController'],
        ...
        function ($compile) {
            return {
                ...
                link: function(scope, el, attrs, formCtrl) {
                    ...
                    var tmpl = formCtrl.fbTmplInstance.getTemplate(scope.type);
                    if(tmpl) {
                        tmpl = $(el).append(tmpl);
                        $compile(tmpl)(scope);
                    }
...
define('text!formBuilder/formFields/checkboxField.html',[],function () { return '<input ng-class="field.css" type="checkbox" name="{{field.name}}" \r\n\tng-model="value"\r\n    ng-attr-placeholder="{{field.placeholder}}">\r\n';});


define('text!formBuilder/formFields/dateField.html',[],function () { return '<input ng-class="field.css" type="date" name="{{field.name}}" \r\n\tng-model="value"\r\n    ng-attr-placeholder="{{field.placeholder}}"\r\n    ng-required="field.validations.required.value"\r\n    ng-min="field.validations.min.value"\r\n    ng-max="field.validations.max.value">\r\n';});


define('text!formBuilder/formFields/dateTimeField.html',[],function () { return '<input ng-class="field.css" type="datetime-local" name="{{field.name}}" \r\n\tng-model="value"\r\n    ng-attr-placeholder="{{field.placeholder}}"\r\n    ng-required="field.validations.required.value"\r\n    ng-min="field.validations.min.value"\r\n    ng-max="field.validations.max.value">\r\n';});


define('text!formBuilder/formFields/emailField.html',[],function () { return '<input ng-class="field.css" type="email" name="{{field.name}}" \r\n\tng-model="value"\r\n    ng-attr-placeholder="{{field.placeholder}}"\r\n    ng-required="field.validations.required.value"\r\n    ng-minlength="field.validations.minlength.value"\r\n    ng-maxlength="field.validations.maxlength.value"\r\n    ng-pattern="field.validations.pattern.value">\r\n';});
...
define('text!formBuilder/formFields/textAreaField.html',[],function () { return '<textarea ng-class="field.css" name="{{field.name}}" \r\n\tng-model="value"\r\n    ng-attr-placeholder="{{field.placeholder}}"\r\n    ng-required="field.validations.required.value"\r\n    ng-minlength="field.validations.minlength.value"\r\n    ng-maxlength="field.validations.maxlength.value"\r\n    ng-pattern="field.validations.pattern.value">\r\n</textarea>\r\n';});


define('text!formBuilder/formFields/textField.html',[],function () { return '<input ng-class="field.css" type="text" \r\n\tname="{{field.name}}" \r\n\tng-model="value"\r\n    ng-attr-placeholder="{{field.placeholder}}" \r\n    ng-required="field.validations.required.value"\r\n    ng-minlength="field.validations.minlength.value"\r\n    ng-maxlength="field.validations.maxlength.value"\r\n    ng-pattern="field.validations.pattern.value">\r\n';});


define('text!formBuilder/formFields/timeField.html',[],function () { return '<input ng-class="field.css" type="time" name="{{field.name}}" \r\n\tng-model="value"\r\n    ng-attr-placeholder="{{field.placeholder}}"\r\n    ng-required="field.validations.required.value"\r\n    ng-min="field.validations.min.value"\r\n    ng-max="field.validations.max.value">\r\n';});


define('text!formBuilder/formFields/urlField.html',[],function () { return '<input ng-class="field.css" type="url" name="{{field.name}}" \r\n\tng-model="value"\r\n    ng-attr-placeholder="{{field.placeholder}}"\r\n    ng-required="field.validations.required.value"\r\n    ng-minlength="field.validations.minlength.value"\r\n    ng-maxlength="field.validations.maxlength.value"\r\n    ng-pattern="field.validations.pattern.value">\r\n';});
...
define('formBuilder/formUtilsFactory',['angular', '_'], function (angular, _) {
    'use strict';
...
define('formBuilder/formDefaultValidationMsgs',[], function () {
    'use strict';
    return {
        ...
        date: 'Invalid date !',
        time: 'Invalid time !',
        datetimelocal: 'Invalid date-time !',
        url: 'Invalid url !',
        max: 'Max validation failed !',
        min: 'Min validation failed !',
        maxlength: 'Max length validation failed !',
        minlength: 'Min length validation failed !',
        pattern: 'Pattern mismatch !'
	};
});

define('formBuilder/formBuilder',['angular','formBuilder/formMainDirective', 'formBuilder/formFields/formFieldDirective',
...
define('comps',['formBuilder/formBuilder'], function() {
	'use strict';
});
/*jshint unused: vars */
